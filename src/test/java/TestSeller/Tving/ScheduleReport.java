...
//        getDriver().navigate().refresh();
    ...
    @Test(description = "Test: Successful Scheduling of report with all mandatory fields", timeOut = 600000)
...
//                reportspage.ClickingOnPopUpCloseButton();
    ...
    @Test(description = "Test: Scheduling of report with negative aspect" , timeOut = 600000)
